...
export const FeatureCardItem: FC<FeatureCardItemProps> = ({ data }) => {
    return (
        <Card
            ...
            radius="md"
            withBorder
            className="w-full bg-[hsl(var(--card))] border-[hsl(var(--border))] shadow-none transition-shadow duration-500 cursor-pointer hover:shadow-lg hover:shadow-[hsl(var(--muted-foreground))] opacity-0 animate-fade-in-up delay-[${600 + index * 150}ms]"
        >
            {/* IMAGEN */}
            <CardSection>
                <Image
